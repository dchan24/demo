...
public class EnterpriseShareMessageHolder extends BaseViewHolder {
	...
	public EnterpriseShareMessageHolder(View itemView, Activity activity , MessageChatListAdapter adapter , BaseChatContract.Presenter presenter) {
	...
	public void bindSendStatus() {
        ...
        if (type == Type.TYPE_MSG_ENTERPRISE_SHARE_SEND) {
