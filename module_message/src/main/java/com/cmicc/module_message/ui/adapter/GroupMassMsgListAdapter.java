...
public class GroupMassMsgListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private GroupSMSListAdapter.OnItemClickListener mOnItemClickListener;
    private String sendTo;

    public GroupMassMsgListAdapter(Context context, ArrayList<GroupMassModel> list) {
        mContext = context;
        mList = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_group_mass, parent, false);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        if(!TextUtils.isEmpty(groupNotify.getPerson())){
            String names = sendTo + groupNotify.getPerson();
...
//            });
    ...
    public void setOnItemClickListener(GroupSMSListAdapter.OnItemClickListener onItemClickListener) {
